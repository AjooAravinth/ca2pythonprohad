...
def reset_variable():
    ...
    all_element = [label_one, label_two, input_2, input_1, listbox, label_three, input_3, label_four, input_4,
                   ...
                   cancle_booking_button, remove_dress_button]
...
def add_dress_(*args, **kwargs):
    global input_8, input_2, input_1, input_3, input_4, input_5, input_6, input_7, button_
    category_id = input_1.get()
    size = input_2.get()
    storeid = input_3.get()
    Name = input_4.get()
    Ideal_For = input_5.get()
    Rental_Rate = input_6.get()
    Description = input_7.get()
    color = input_8.get()
    sucess, msg = dress_db.add_dress(storeid=storeid,
